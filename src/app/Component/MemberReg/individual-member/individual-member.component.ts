...
export class IndividualMemberComponent implements OnInit {
    // flags
    getErr:any=false
    flag_1: any = true
    flag_2: any = true
    ...
    Name: any;
    maxDate: any;
  disableMemId: boolean=true;
  currentDate  = formatDate(new Date(), 'dd/MM/YYYY', 'en');
  // currentDate :any ;
  dateForm: any = new FormGroup({
    'Date': new FormControl({ value: this.currentDate}, [Validators.required])
  })
  selectedDate: any;
...
this.disableMemId=true;
    ...
    OnLoad() {
      ...
      // this.currentDate = this.dateForm.get('Date').value;
      // this.currentDate=this.currentDate.value;
...
this.currentDate=this.selectedDate;
    ...
    showMember(No: any) {
      No=sessionStorage.getItem('MemberId')
      console.log(No);
      No=+No
      console.log(No);
